...
import { createPressReleaseXmlFile } from './press-release-helper';
import { sparqlEscapeDateTime } from 'mu';
import { BELGA_PUBLICATION_CHANNEL } from '../config';
import { publishToBelga } from './belga-service';
...
class PublicationTask {
  ...
  */
   ...
   */
  async publish() {
    const filePath = await createPressReleaseXmlFile(this);
    await publishToBelga(filePath);
  }
